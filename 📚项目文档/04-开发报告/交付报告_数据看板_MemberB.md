...
*   **[NEW] 专题统计**: 新增右侧独立**饼状图**，专门展示非遗项目的**类别占比**（如传统技艺、民俗等），支持与左侧城市统计图联动。
...
### 📤 数据导出 (Data Export)
*   **[NEW] 成果输出**: 实现了仪表盘分析结果的导出功能。
    *   **图片导出**: 支持将当前仪表盘（含左右双图表）保存为高清 PNG 图片。
    *   **报表导出**: 支持将当前年份的详细统计数据（各市数量、分类占比）导出为 TXT 文本报告，便于二次分析。
